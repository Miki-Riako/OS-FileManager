...
#include "./entity/FileManagerSystemInfo.h" //超级块对象
...
public:
    FileManagerSystem(); //构造函数，创建空闲块，磁盘打开标记设置为false
    ~FileManagerSystem(); //析构函数，将更新后的systemInfo写入磁盘
...
private:
    ...
    FileManagerSystemInfo systemInfo; //文件系统超级块
